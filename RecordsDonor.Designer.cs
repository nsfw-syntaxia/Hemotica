namespace Hemotica
{
	partial class RecordsDonor
	{
		...
		private void InitializeComponent()
		{
			...
			tbxCNumber.Hint = "";
			tbxCNumber.Location = new Point(666, 49);
			...
			cmbxBarangay.Location = new Point(354, 190);
			...
			// cmbxBType
			// 
			cmbxBType.BackColor = Color.White;
			...
			cmbxBType.Font = new Font("Arial Narrow", 15F, FontStyle.Bold);
			...
			cmbxBType.ItemHeight = 35;
			cmbxBType.Items.AddRange(new object[] { "Select blood type", "A+", "A-", "B+", "B-", "O+", "O-", "AB+", "AB-" });
			cmbxBType.Location = new Point(666, 96);
