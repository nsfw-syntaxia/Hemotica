namespace Hemotica
{
    partial class RegisterDP2
    {
		...
		private void InitializeComponent()
		{
			...
			lblFName.Font = new Font("Arial Narrow", 13F, FontStyle.Bold);
			lblFName.ForeColor = Color.FromArgb(216, 85, 101);
			lblFName.Location = new Point(3, 4);
			lblFName.Name = "lblFName";
			lblFName.Size = new Size(85, 22);
			...
			lblMName.Size = new Size(274, 22);
			lblMName.TabIndex = 26;
			lblMName.Text = "Middle Name (If not applicable, \"N/A\")";
			// 
			// lblLName
			// 
			...
			rbtnMale.CheckedColor = Color.FromArgb(236, 124, 132);
			rbtnMale.DisabledColor = Color.FromArgb(216, 85, 101);
			rbtnMale.DisabledStringColor = Color.FromArgb(216, 85, 101);
			rbtnMale.Enable = true;
			rbtnMale.EnabledCheckedColor = Color.FromArgb(216, 85, 101);
			rbtnMale.EnabledStringColor = Color.FromArgb(216, 85, 101);
			...
			rbtnFemale.CheckedColor = Color.FromArgb(236, 124, 132);
			rbtnFemale.DisabledColor = Color.FromArgb(216, 85, 101);
			rbtnFemale.DisabledStringColor = Color.FromArgb(216, 85, 101);
			rbtnFemale.Enable = true;
			rbtnFemale.EnabledCheckedColor = Color.FromArgb(216, 85, 101);
			rbtnFemale.EnabledStringColor = Color.FromArgb(216, 85, 101);
			...
			// rbtnPNTS
			// 
			rbtnPNTS.AutoSize = true;
			rbtnPNTS.CheckedColor = Color.FromArgb(236, 124, 132);
			rbtnPNTS.DisabledColor = Color.FromArgb(216, 85, 101);
			rbtnPNTS.DisabledStringColor = Color.FromArgb(216, 85, 101);
			rbtnPNTS.Enable = true;
			rbtnPNTS.EnabledCheckedColor = Color.FromArgb(216, 85, 101);
			rbtnPNTS.EnabledStringColor = Color.FromArgb(216, 85, 101);
