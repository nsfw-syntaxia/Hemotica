namespace Hemotica
{
	partial class HospitalTransfusions
	{
		/// <summary> 
		...
		private void InitializeComponent()
		{
			...
			btnAvailability.Location = new Point(321, 454);
			...
			btnTransfusion.Location = new Point(514, 454);
			...
			lblQuantity.Location = new Point(282, 355);
			...
			lblPatient.Location = new Point(298, 120);
			...
			lblBlood.Location = new Point(251, 214);
			...
			lblPhysician.Location = new Point(267, 49);
			...
			lblUnit.Location = new Point(594, 355);
			...
			lblResult.Font = new Font("Bahnschrift", 17F, FontStyle.Bold);
			lblResult.ForeColor = Color.FromArgb(216, 85, 101);
			lblResult.Location = new Point(452, 556);
			lblResult.Name = "lblResult";
			lblResult.Padding = new Padding(5, 0, 0, 5);
			lblResult.Size = new Size(111, 33);
			...
			cmbxPhysician.Location = new Point(408, 46);
			...
			tbxBlood.Hint = "";
			tbxBlood.Location = new Point(408, 211);
			...
			tbxPriority.Hint = "";
			tbxPriority.Location = new Point(408, 305);
			...
			tbxQuantity.Hint = "";
			tbxQuantity.Location = new Point(408, 352);
			...
			lblPriority.Location = new Point(291, 313);
			...
			cmbxPatient.Location = new Point(408, 117);
			...
			tbxBirthdate.Hint = "";
			tbxBirthdate.Location = new Point(408, 164);
			...
			tbxCNumber.Hint = "";
			tbxCNumber.Location = new Point(408, 258);
			...
			tbxCNumber.Size = new Size(349, 41);
			tbxCNumber.TabIndex = 95;
			...
			lblCNumber.Font = new Font("Bahnschrift", 20F, FontStyle.Bold);
			lblCNumber.ForeColor = Color.FromArgb(216, 85, 101);
			lblCNumber.Location = new Point(185, 261);
			lblCNumber.Name = "lblCNumber";
			lblCNumber.Padding = new Padding(5, 0, 0, 5);
			lblCNumber.Size = new Size(217, 38);
			lblCNumber.TabIndex = 96;
